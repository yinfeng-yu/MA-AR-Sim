...
public class RawVideoCapture : MonoBehaviour
{
    ...
    [System.Serializable]
    private class MyEvent : UnityEvent<MLCamera.ResultExtras, MLCamera.YUVFrameInfo, MLCamera.FrameMetadata> { }
    ...
    public void OnRawCaptureDataReceived(MLCamera.ResultExtras extras, MLCamera.YUVFrameInfo frameData, MLCamera.FrameMetadata frameMetadata)
    {
        ...
        MLResult result = MLCVCamera.GetFramePose(extras.VcamTimestampUs * 1000, out matrix);
